...
namespace math3D{
	...
	Quaternion::Quaternion(const Quaternion& q){
		...
		this->z = q.z;
		this->w = q.w;
		this->euler= weak_ptr<Euler>{q.euler};
	}
	...
	shared_ptr<Euler> Quaternion::getEuler()const{
		return this->euler.lock();
	}

	Quaternion& Quaternion::setEuler(shared_ptr<Euler> euler){
		this->euler= weak_ptr<Euler>(euler);
		return *this;
	}
	...
	Quaternion& Quaternion::setFromEuler(Euler& euler , bool update){
	    ...
	    if ( euler.getOrder() == string("XYZ") ) {
	        this->x = s1 * c2 * c3 + c1 * s2 * s3;
	        this->y = c1 * s2 * c3 - s1 * c2 * s3;
	        this->z = c1 * c2 * s3 + s1 * s2 * c3;
	        this->w = c1 * c2 * c3 - s1 * s2 * s3;

	    } else if ( euler.getOrder() == string("YXZ") ) {
	        this->x = s1 * c2 * c3 + c1 * s2 * s3;
	        this->y = c1 * s2 * c3 - s1 * c2 * s3;
	        this->z = c1 * c2 * s3 - s1 * s2 * c3;
	        this->w = c1 * c2 * c3 + s1 * s2 * s3;

	    } else if ( euler.getOrder() == string("ZXY") ) {
	        this->x = s1 * c2 * c3 - c1 * s2 * s3;
	        this->y = c1 * s2 * c3 + s1 * c2 * s3;
	        this->z = c1 * c2 * s3 + s1 * s2 * c3;
	        this->w = c1 * c2 * c3 - s1 * s2 * s3;

	    } else if ( euler.getOrder() == string("ZYX") ) {
	        this->x = s1 * c2 * c3 - c1 * s2 * s3;
	        this->y = c1 * s2 * c3 + s1 * c2 * s3;
	        this->z = c1 * c2 * s3 - s1 * s2 * c3;
	        this->w = c1 * c2 * c3 + s1 * s2 * s3;

	    } else if ( euler.getOrder() == string("YZX") ) {
	        this->x = s1 * c2 * c3 + c1 * s2 * s3;
	        this->y = c1 * s2 * c3 + s1 * c2 * s3;
	        this->z = c1 * c2 * s3 - s1 * s2 * c3;
	        this->w = c1 * c2 * c3 - s1 * s2 * s3;

	    } else if ( euler.getOrder() == string("XZY") ) {
	        this->x = s1 * c2 * c3 - c1 * s2 * s3;
	        this->y = c1 * s2 * c3 - s1 * c2 * s3;
	        this->z = c1 * c2 * s3 + s1 * s2 * c3;
	        this->w = c1 * c2 * c3 + s1 * s2 * s3;
